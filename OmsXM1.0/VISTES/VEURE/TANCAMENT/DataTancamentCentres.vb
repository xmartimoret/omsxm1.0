Public Class DataTancamentCentres
    Inherits DGVObjects
    ...
    Public Overrides Function getRows() As List(Of List(Of CodiDescripcio))
        Dim sg As Subgrup, c As Centre, dades As List(Of List(Of CodiDescripcio)), fila As List(Of CodiDescripcio), valor As Double
        ...
        For Each sg In dadesInforme.grupComptable.subgrups
            ...
            For Each c In dadesInforme.seccioActual.centres
                valor = c.saldoDetall(sg.id, dadesInforme.mesActual.num, dadesInforme.isValorAcumulat)
    ...
    Public Overrides Sub setData(c As String, f As String)
        Dim _c As Centre, sg As Subgrup
        _c = Nothing
