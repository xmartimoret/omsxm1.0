Public Class dataPretancamentSubformulariDesglossat
    Inherits DGVObjects
    Friend Property assentaments As List(Of Assentament)
    Private codiDades As String
    Public Sub New()
        MyBase.New(False)
    End Sub
    Public Sub New(pAssentaments As List(Of Assentament), pCodi As String)
        MyBase.New(False)
        codiDades = pCodi
