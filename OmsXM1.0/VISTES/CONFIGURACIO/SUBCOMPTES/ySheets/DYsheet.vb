...
Public Class DYsheet
    Private ySheetActual As YSheet
    Public Sub New()
        InitializeComponent()
    End Sub
    Public Function getYsheet(pYSheet As YSheet) As YSheet
        ySheetActual = pYSheet
        If ySheetActual.id = -1 Then
    ...
    End Function
    Private Sub setData()
        lblId.Text = ySheetActual.id
        txtCodi.Text = ySheetActual.codi
        txtNom.Text = ySheetActual.nom
        txtNotes.Text = ySheetActual.notes
    End Sub
    ...
    Private Function getData() As YSheet
        getData = ySheetActual.copy
    ...
    Private Sub txtCodi_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtCodi.KeyPress
        e.KeyChar = VALIDAR.AlfaNumeric(e.KeyChar, txtCodi.Text.Length, 10)
        e.Handled = False
    End Sub
End Class
