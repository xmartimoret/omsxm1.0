Public Class pArticlesComandes
    ...
    '    Dim ruta As String
    '    ruta = getRutaPDF(c.empresa.id, c.codi, Strings.Right(c.getAnyo, 2))
    '    If CONFIG.fileExist(ruta) Then
    '        Call frmIniComanda.mostrarComandaValidacio(c, ruta)
    '    Else
    ...
    Private Sub setTotal()
        ...
        For Each c In pComandes.lstData.Items
            base = base + c.SubItems(10).Text
            iva = iva + (c.SubItems(11).Text) - c.SubItems(10).Text
        Next
