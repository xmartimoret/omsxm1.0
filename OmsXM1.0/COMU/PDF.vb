...
Module PDF
    ...
    'Public Function getPDF(ruta As String)
    '    Dim pID As Integer, obj As Object
    '    If existProcess("AcroRd32") Then

    '        obj = Interaction.GetObject("", "AcroRd32.application")
    '        GetWindowThreadProcessId(obj.Hwnd, pID)
    ...
    Public Sub killProcess()
        ...
        For Each p In myProcesses
            Call p.Kill()
        Next
        'myProcesses = Process.GetProcessesByName("Acrord64")
        'For Each p In myProcesses
        '    Call p.Kill()
        'Next
    End Sub
